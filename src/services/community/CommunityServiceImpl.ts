...
export class CommunityService implements ICommunityService {
    ...
    @Transaction()
    async communityfindByCode(code: string, userId?: number | undefined): Promise<CommunityResponse> {
    ...
    @Transaction()
    async voteChange(userId: number, communityId: number, voteType: VoteType): Promise<void> {
